...
The following Disruption Budgets says, for a 8 hour timeframe from UTC 9:00 don’t disrupt any nodes voluntary as this might be when the application is receiving peak traffic.
